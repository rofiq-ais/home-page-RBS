      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="mt-6 max-w-xl mx-auto lg:mx-0 text-lg text-gray-500 sm:text-xl leading-relaxed">
            ...
            <span className="font-semibold text-green-700">sesuai sunnah</span>{" "}
            yang higienis, legal, dan profesional. Temukan kesehatan holistik di Jakarta Utara.
          </p>
